//! SEP-41 compliant Soroban token with mint, transfer_from, burn, and burn_from.
...
#[contractimpl]
impl Token {
    /// Constructor sets admin/metadata and mints the initial supply to `initial_holder`.
    pub fn __constructor(
        ...
        check_nonnegative_amount(initial_mint_amount);
        ...
        if initial_mint_amount > 0 {
            receive_balance(&e, initial_holder.clone(), initial_mint_amount);
